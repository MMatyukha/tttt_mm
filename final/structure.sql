...
INSERT INTO `order` (id,customer_id,created_at,delivery_id)
...
-- Table 'warehouse_good'
-- Запасы на складе
-- ---

DROP TABLE IF EXISTS `warehouse_good`;
		
CREATE TABLE `warehouse_good` (
  `id` int NOT NULL AUTO_INCREMENT,
...
INSERT INTO `warehouse_good`  VALUES
